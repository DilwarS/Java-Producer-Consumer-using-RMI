...
public class Producer {
    ...
    public static void main(String args[]) throws FileNotFoundException, RemoteException, MalformedURLException{
       ...
       */
        String remoteHostName = "192.168.43.13";
        int remotePort = 9090;
        String connectLocation = "//" + remoteHostName + ":" + remotePort+ "/XRMIServer";
                
       try{
           producer_stub = (Bank) Naming.lookup("rmi://192.168.43.13:9090/RMIServer");
